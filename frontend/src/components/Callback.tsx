...
export default function Callback(props: CallbackProps) {
    ...
    return (
        <>
            ...
            <Transition.Root show={callbackOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setCallbackOpen}>
                <Transition.Child
                as={Fragment}
                ...
                <div className="flex min-h-full items-center justify-center">
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-md bg-[#012D30] text-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="p-6">
                            ...
                            >
                                <div className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 mt-8">
                                    <div>
                                    ...
                                    <div>
                                        <label htmlFor="cb-phone" className="block text-sm">
                                            {t('content.phone')}
                                        </label>
                                        <div className="mt-2">
                                            <input
                                    ...
                                    <div className='md:col-span-2'>
                                        <label htmlFor="cb-question" className="block text-sm">
                                            {t('content.question')}
                                        </label>
                                        <div className="mt-2">
                                            <textarea
                                            name="question"
                                            id="cb-question"
                                            placeholder={t('content.questionPl')}
                                            required
